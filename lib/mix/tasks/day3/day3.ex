defmodule Mix.Tasks.AOC.Day3 do
  ...
  def distanceFromOriginToClosestIntersection(instructions) do
    [coordinates1, coordinates2] = instructions
    |> parseInstructions()
    ...
    crossCoordinates |> Enum.map(fn coordinate -> manhattenDistance(coordinate) end) |> Enum.sort() |> List.first()
  end
  ...
  def run(_) do
    ...
    input = "./lib/mix/tasks/day3/input3.txt"
    |> File.read!()
    |> String.trim()
