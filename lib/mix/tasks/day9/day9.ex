defmodule Mix.Tasks.AOC.Day9 do
  ...
  def runInstruction({3, mode_1, _, _}, index, instructions, inputs, output, inputIndex, relative_base_offset) do
    ...
    parameter = parameter_index_for_mode(instructions, mode_1, raw_parameter, relative_base_offset)
    IO.puts("3 param #{parameter}")
  ...
  def runInstruction({4, mode_1, _, _}, index, instructions, _, _, inputIndex, relative_base_offset) do
    ...
    output_index = parameter_index_for_mode(instructions, mode_1, parameter, relative_base_offset)
